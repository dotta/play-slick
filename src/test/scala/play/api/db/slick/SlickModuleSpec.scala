...
class SlickModuleSpec extends Specification {
  ...
  "SlickModule" should {
    ...
    "bind DynamicEvolutions to SlickDynamicEvolutions" in {
      val evolutions = injector.instanceOf[DynamicEvolutions]
      evolutions must beAnInstanceOf[SlickDynamicEvolutions]
    }
    "bind DynamicEvolutions as a singleton" in {
      val evolutions1 = injector.instanceOf[DynamicEvolutions]
      val evolutions2 = injector.instanceOf[DynamicEvolutions]
      evolutions1 mustEqual evolutions2
    }
